...
公開Pull Requestが正式に取り込まれる前に、maintainerは公開候補との一致、内部情報の非混入、ARM64／x64 CIを確認します。Contributorが非公開の運用fileや環境を用意する必要はありません。

コントリビューションは、プロジェクトと同じMIT Licenseで提供されるものとして扱います。

## 行動

相手の背景や経験にかかわらず、具体的で敬意ある会話をお願いします。人格ではなく、再現手順、利用者影響、コード、テストを議論してください。詳細は[行動規範](CODE_OF_CONDUCT.md)を確認してください。
